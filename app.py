...
def lime_explanation():
    ...
    temp, mask = explanation.get_image_and_mask(
        ...
        positive_only=False,
        num_features=img_size[0],
        hide_rest=False
    )
    lime_path = "static/lime_image.jpg"
    temp_img = Image.fromarray(np.uint8(mark_boundaries(temp / 2 + 0.5, mask) * 255))  # Convert to PIL Image
    temp_img.save(lime_path)
